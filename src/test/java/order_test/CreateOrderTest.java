...
public class CreateOrderTest {
    ...
    public static Object[][] getTestData(){
        return new Object[][]{
                ...
                {new OrderData("Джейсон","Стэйтем","Мира ул","Проспект Мира","8123222333444",3,"2023-10-30","Позвонить за час",new String[]{"GREY"})},
                {new OrderData("Daniel","Craig","Лубянка 100","Лубянка","+79316753434",4,"2023-09-01","Позвонить за час",new String[]{"BLACK","GREY"})},
                {new OrderData("Guy","Ritchie","Новый арбат","Театральная","89225557733",5,"2023-08-10","Позвонить за час",new String[]{})}
        };
    }
